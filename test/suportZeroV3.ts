...
const erc20Address = coder.decodeInput<ERC20Type>(erc20Data).values['tokenContract']
...
const asset721 = coder.decodeInput<ERC721Type>(erc721Data)
...
const asset1155 = coder.decodeInput<ERC1155Type>(erc1155Data)
